...
- services - source code for different sections of the pipeline - adapter, agent, meter, relay, etc
- setups - example setups to demonstrate different modules
- shell - shell scripts

Adapter plugins are defined in services/adapter/src/drivers.

Setup config for a client is in a sibling folder, ../client-[client].
