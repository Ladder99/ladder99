// diode sender
// receives data on tcp and sends it to diode receiver via udp.

import dgram from 'dgram' // UDP
import net from 'net' // TCP
import config from './config.js'

console.log(`Diode Sender`)
console.log(`Receives TCP msgs and sends them to Diode Receiver via UDP.`)
console.log(`----------------------------------------------------------------`)
